...
const _BarElement: GenericBar = require('./generic-bar')
const _options = require('./options')
const _EventEmitter: EventEmitter = require('events')

class MultiBar extends _EventEmitter {
  /**  list of bars */
  bars: GenericBar[]
  /**  parse+store options */
  ...
  create (total: number, startValue: number, payload: Payload) {
