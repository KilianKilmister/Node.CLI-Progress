...
const _ETA: ETA = require('./eta')
const _Terminal: Terminal = require('./terminal')
const _formatter = require('./formatter')
const _EventEmitter: EventEmitter = require('events')
class GenericBar extends _EventEmitter {
  /** store options */
  ...
  formatter: (options: ProgressBarOptions, params, payload: Payload) => string
  ...
  start (total?: number, startValue?: number, payload?: Payload) {
    /** set initial values */
   ...
   * @param payload
   */
  increment (value?: number, payload?: Payload)
  /**
   * update the bar value
   * @param payload
   */
  increment (payload?: Payload)
  increment (arg0: Payload | number = 1, arg1? = {}) {
